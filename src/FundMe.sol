...
//Check remappings in foundry.toml for why this is resolving to correct path
...
contract FundMe {
    ...
    //variables with s_ prefix are used to indicate that they are storage variables
    ...
    string public constant FUND_MIN_REVERT_MESSAGE = "You need to spend more ETH!";
    ...
    function fund() public payable {
        require(msg.value.getConversionRate(s_priceFeed) >= MINIMUM_USD, FUND_MIN_REVERT_MESSAGE);
